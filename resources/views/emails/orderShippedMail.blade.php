                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td width="560" class="es-m-p0r esd-container-frame" valign="top" align="center">
                                                                        <table cellpadding="0" cellspacing="0" width="100%" height="20px";>
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image es-p10b" style="font-size: 0px;"><a target="_blank"></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10b es-m-txt-c">
                                                                                        <h1 style="font-size: 26px; line-height: 100%;">Detalles de tu orden</h1>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                    ...
                                    <td class="esd-stripe" align="center">
                                        <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600" >
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p20" align="left" >
                                                        <table cellpadding="0" cellspacing="0" width="100%" style="border-bottom: 2px solid #efefef;">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="560" class="esd-container-frame" align="center" valign="top">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-m-txt-c">
                                                                                        <h3>Orden&nbsp;<a target="_blank">#{{$orden->id}}</a></h3>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                ...
                                                @foreach ($orden->ordersDetail as $detalle_orden)
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="left" class="esd-block-text">
                                                                                                        <p><strong>{{$detalle_orden->descripcion}}</strong></p>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="center" class="esd-block-text">
                                                                                                        @if ($detalle_orden->cantidad > 1 )
                                                                                                            <p>{{$detalle_orden->cantidad}} pzas.</p>
                                                                                                        @else
                                                                                                            <p>{{$detalle_orden->cantidad}} pza.</p>
                                                                                                        @endif
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                    ...
                                                                    <td width="280" class="es-m-p0r esd-container-frame es-m-p20b" align="center">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text">
                                                                                        <p>Cliente: <strong>{{$orden->nombre}}</strong></p>
                                                                                        <p>Telefono:<strong>{{$orden->telefono}}</strong></p>
                                                                                        <p>Correo: <strong>{{$orden->correo}}</strong></p>
                                                                                        <p>Numero de orden:&nbsp;<strong>#{{$orden->id}}</strong></p>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-m-txt-l">
                                                                                        <p>Datos de envio:</p>
                                                                                        <p>
                                                                                            <strong>Recibe {{$orden->nombrePersonaRecibir}},<br>
                                                                                                {{$orden->calle}},
                                                                                                {{$orden->noExterior}}@if($orden->noInterior),
                                                                                                apto. {{$orden->noInterior}}.
                                                                                                @else.@endif 
                                                                                                <br>
                                                                                                @if ($orden->cp)
                                                                                                C.P. {{$orden->cp}}
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10t es-p10b">
                                                                                        <p>Tienes alguna pregunta?&nbsp;Correo electronico&nbsp;<a target="_blank" href="mailto:support@acuatica.gmail">support@acuatica.gmail</a><a target="_blank" href="mailto:">stylecasual</a><a target="_blank" href="mailto:">.com</a>&nbsp;o puedes llamar al numero&nbsp;<a target="_blank" href="tel:">5511223344</a>.</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="center" class="esd-block-social es-p15t es-p15b" style="font-size:0">
                                                                                        <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="center" valign="top" class="es-p40r"><a target="_blank" href><img title="Facebook" src="https://jwgzbw.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" alt="Fb" width="32"></a></td>
                                                                                                    <td align="center" valign="top" class="es-p40r"><a target="_blank" href><img title="Twitter" src="https://jwgzbw.stripocdn.email/content/assets/img/social-icons/logo-black/twitter-logo-black.png" alt="Tw" width="32"></a></td>
                                                                                                    <td align="center" valign="top" class="es-p40r"><a target="_blank" href><img title="Instagram" src="https://jwgzbw.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" alt="Inst" width="32"></a></td>
                                                                                                    <td align="center" valign="top"><a target="_blank" href><img title="Youtube" src="https://jwgzbw.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png" alt="Yt" width="32"></a></td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td width="560" class="esd-container-frame" align="center" valign="top">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-infoblock" height="20px";>
