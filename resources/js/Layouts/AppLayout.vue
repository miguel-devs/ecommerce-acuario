...
import MessageWarning from '@/Components/MessageWarning.vue';
...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <JetNavLink :href="route('dashboard.ordenes')" :active="route().current('dashboard.ordenes')">
                                    Ordenes
                                </JetNavLink>
                            </div>
                        </div>
           ...
           <MessageSuccess :messageSuccess="$page.props.flash.success" />
           <MessageWarning :messageWarning="$page.props.flash.warning" />
        </div>
    </div>
</template>
