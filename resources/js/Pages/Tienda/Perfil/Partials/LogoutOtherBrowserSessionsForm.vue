...
<template>
    <JetActionSection>
        ...
        <template #description>
            Administra tu actividad en otros navegadores y dispositivos
        </template>
        ...
        <template #content>
            ...
            <JetDialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Por favor introduce tu contraseña para confirmar que quieres cerrar las sesiones de otros navegaodres y todos tus dispositivos
                    <div class="mt-4">
                        <JetInput
                            ref="passwordInput"
                ...
                <template #footer>
                    ...
                    <JetButton
                        class="ml-3 bg-sky-500 hover:bg-sky-600"
